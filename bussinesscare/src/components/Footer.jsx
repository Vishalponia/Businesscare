...
//             <ul className="footer-list-luxury">
//               <li>About</li>
//               <li>Awards</li>
...
//               {/* ⭐ FORM OPEN LINK ⭐ */}
//               <li>
//                 <Link to="/registration-form" className="hover:text-yellow-400 duration-200">
...
//             <a className="luxury-bottom-link">Privacy Policy</a>
//             <a className="luxury-bottom-link">Cookie Policy</a>
//           </div>
//         </div>
...
//                     bg-gradient-to-r from-yellow-300 to-yellow-600 
//                     transition-all duration-300 hover:w-full rounded-full"
//                   ></span>
